...
render(siteMainElement, Object(_view_main_navigation_js__WEBPACK_IMPORTED_MODULE_1__["createMainNavigationTemplate"])(), `afterbegin`);
render(siteMainElement, Object(_view_sort_js__WEBPACK_IMPORTED_MODULE_2__["createSortTemplate"])(), `beforeend`);
render(siteMainElement, Object(_view_films_js__WEBPACK_IMPORTED_MODULE_3__["createFilmsTemplate"])(), `beforeend`);
...
do {
  render(filmsListContainerElement, Object(_view_film_card_js__WEBPACK_IMPORTED_MODULE_4__["createFilmCardTemplate"])(), `beforeend`);
  i++;
} while (i < FILMS_CARDS_COUNT);

render(filmsListElement, Object(_view_show_more_button_js__WEBPACK_IMPORTED_MODULE_5__["createShowMoreButtonTemplate"])(), `beforeend`);
...
filmsListExtraElements.forEach((element) => {
  ...
  do {
    render(filmsListExtraContainerElement, Object(_view_film_card_js__WEBPACK_IMPORTED_MODULE_4__["createFilmCardTemplate"])(), `beforeend`);
    x++;
...
render(footerStatisticsElement, Object(_view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_6__["createFooterStatisticsTemplate"])(), `beforeend`);

render(footerElement, Object(_view_film_details_popup_js__WEBPACK_IMPORTED_MODULE_7__["createFilmDetailsPopupTemplate"])(), `afterend`);
